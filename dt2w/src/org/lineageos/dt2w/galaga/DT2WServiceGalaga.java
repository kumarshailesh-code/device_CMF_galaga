...
public class DT2WServiceGalaga extends Service {
    private static final String TAG = "DT2WServiceGalaga";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.galaga.dt2w", dt2wEnabled ? "1" : "0");
        }
